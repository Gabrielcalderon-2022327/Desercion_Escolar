...
public class Estudiante {
    ...
    @NotBlank(message = "El apellido del es un campo obligatorio")
    ...
    @NotNull(message = "El id del encargado es un campo obligatorio")
    private Integer fk_id_encargado;

    @Column(name = "fk_id_grado")
    @NotNull(message = "El id del grado es un campo obligatorio")
    ...
    public LocalDate getFecha_nacimiento_estudiante() {
        return fecha_nacimiento_estudiante;
    }
    public void setFecha_nacimiento_estudiante(LocalDate fecha_nacimiento_estudiante) {
        this.fecha_nacimiento_estudiante = fecha_nacimiento_estudiante;
    }
    ...
    public Integer getTelefono_estudiante() {
        return telefono_estudiante;
    }
    public void setTelefono_estudiante(Integer telefono_estudiante) {
        this.telefono_estudiante = telefono_estudiante;
    }

    public Integer getFk_id_encargado() {
        return fk_id_encargado;
    }
    public void setFk_id_encargado(Integer fk_id_encargado) {
        this.fk_id_encargado = fk_id_encargado;
    }

    public Integer getFk_id_grado() {
        return fk_id_grado;
    }
    public void setFk_id_grado(Integer fk_id_grado) {
